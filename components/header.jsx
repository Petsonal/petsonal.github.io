    ...
    return (
        ...
        <Navbar>
            <a className="flex items-center hovesr:opacity-75 ltr:mr-auto rtl:ml-auto" href="/">
                ...
                <span className="max-md:hidden select-none font-extrabold ltr:ml-2 rtl:mr-2" title="petsonal.github.io: Gesture Generation Research Community">petsonal.github.io</span>
            </a>
            ...
            <a href="https://petsonal.github.io/" target="blank" rel="blank" className=" contrast-more:text-gray-700 contrast-more:dark:text-gray-100 max-md:hidden whitespace-nowrap text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" aria-current="false">Petsonal ↗</a>
